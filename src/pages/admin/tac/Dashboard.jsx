    ...
    <div className="min-h-screen bg-slate-950 text-white p-6">
      <div className="mx-auto max-w-6xl">
        <div className="mb-8 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div>
            <h1 className="text-3xl font-bold">TAC Dashboard</h1>
            <p className="text-slate-400">Welcome, {adminUser?.title || "TAC Admin"}</p>
          </div>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <div className="rounded-2xl bg-white/10 p-5 border border-white/10">
            ...
            <h2 className="mt-2 text-2xl font-bold">Plan & Structure</h2>
          </div>
          <div className="rounded-2xl bg-white/10 p-5 border border-white/10">
            <p className="text-slate-400 text-sm">Timetable</p>
            <h2 className="mt-2 text-2xl font-bold">Create & Edit</h2>
          </div>
          <div className="rounded-2xl bg-white/10 p-5 border border-white/10">
            <p className="text-slate-400 text-sm">Lecturers</p>
            <h2 className="mt-2 text-2xl font-bold">Assign Teaching</h2>
          </div>
        </div>
      </div>
    </div>
